...
export const metadata: Metadata = {
  ...
  description: "Crafting blockchain solutions and AI-powered web applications. Building the future at the intersection of Web3 and intelligent technologies.",
};
